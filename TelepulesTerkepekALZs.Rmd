---
title: "Magyar települések közúti elérhetősége -- településszintű térképek (L-Zs)"
author:
...
knitr::kable(data.frame(`Település` = locs$NAME,
                        ...
                        `Izokrón vonalakkal` = paste0("[PDF](", baseurl, locs$FileNAME,
                                                      ...
                                                      "_izokron.png)"),
                        check.names = FALSE)[(sum(table(substring(locs$NAME, 1, 1))[
                          names(table(substring(locs$NAME, 1, 1)))<="K"])+1):length(locs$NAME),],
             row.names = FALSE)
```