...
A fenti rendszer felállításának és az útvonaltervezés végrehajtásának a technikai részleteit [külön pontban](#az-%C3%BAtvonaltervez%C3%A9s-technikai-r%C3%A9szletei) tárgyalom meg.
...
Az eredményeket egy [külön oldalon](TelepulesTerkepek.html) tettem elérhetővé: itt bárki letöltheti tehát minden magyar településre a fenti közúti eljutási idő térképeket!
